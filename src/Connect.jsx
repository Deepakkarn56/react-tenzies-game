                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-center h-screen'>
                            <div className='p-4 rounded-lg shadow-md w-64 bg-white flex flex-col items-center'>
                                <h2 className='text-lg font-bold mb-4'>Unleash the Dice Magic</h2>
                                <p className='text-center mb-4 font-serif'>Dive into the Thrilling Universe of Tenzie Frenzy, Where Every Dice Roll Unleashes a Cascade of Excitement, and the Adventure Begins with Unmatched Intensity!</p>
